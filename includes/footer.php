            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-4 mb-md-0">
                        ...
                        <p class="text-muted">Your one-stop shop for all your needs. High-quality products at affordable prices.</p>
                    </div>
                    <div class="col-md-4 mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <?php if(isLoggedIn()): ?>
                                <li class="mb-2"><a href="/account.php" class="text-decoration-none text-muted">My Account</a></li>
                            <?php else: ?>
                                <li class="mb-2"><a href="/login.php" class="text-decoration-none text-muted">Login</a></li>
                                <li class="mb-2"><a href="/register.php" class="text-decoration-none text-muted">Register</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <h5 class="mb-3">Contact Us</h5>
                        <p class="text-muted mb-2">Email: support@shopnow.com</p>
                        <p class="text-muted mb-2">Phone: +1 (123) 456-7890</p>
                        <div class="mt-3">
                            <a href="#" class="text-decoration-none me-3 text-muted"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="text-decoration-none me-3 text-muted"><i class="fab fa-twitter"></i></a>
                            <a href="#" class="text-decoration-none me-3 text-muted"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
